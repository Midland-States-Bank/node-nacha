...
aba = validator.aba, abaFull = validator.abaFull, abaFullPlus = validator.abaFullPlus, date = validator.date, time = validator.time, alphanumeric = validator.alphanumeric;
      ...
      fields: [
        {
          ...
          name: 'interfaceControlStandardsIdentifier',
          length: 1
        }, {
          name: 'dataElementSeparator',
          length: 1,
